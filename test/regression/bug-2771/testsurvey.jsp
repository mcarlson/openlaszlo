...
* X_LZ_COPYRIGHT_END ****************************************************** -->
<?ignore
    Dummy JSP for form submission; "persists" vote count in app variables.
    The values will get reset to the defaults when the web app is stopped.

    A real app would persist the votes using a standard persistence 
    mechanism.
?>
