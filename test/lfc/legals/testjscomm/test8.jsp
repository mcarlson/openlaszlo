...
//* A_LZ_COPYRIGHT_END ********************************************************
   ...
   <body><script type="text/javascript">
              Lz.swfEmbed({url: 'copy-of-hello.lzx?lzt=swf&lzr=swf8', bgcolor: '#ffffff', width: '100%', height: '200', id: 'lzappa', accessible: 'false'});
              Lz.swfEmbed({url: 'copy-of-hello.lzx?lzt=swf&lzr=swf8', bgcolor: '#ffffff', width: '100%', height: '200', id: 'lzappb', accessible: 'false'});
