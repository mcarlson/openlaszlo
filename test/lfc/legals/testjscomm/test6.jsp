...
//* A_LZ_COPYRIGHT_END ********************************************************
   ...
   <body><script type="text/javascript">
              lz.embed.swf({url: 'copy-of-hello.lzx?lzt=swf&lzr=swf7', bgcolor: '#ffffff', width: '100%', height: '200', id: 'lzappa', accessible: 'false'});
              lz.embed.swf({url: 'copy-of-hello.lzx?lzt=swf&lzr=swf7', bgcolor: '#ffffff', width: '100%', height: '200', id: 'lzappb', accessible: 'false'});
