...
//* A_LZ_COPYRIGHT_END ********************************************************
        ...
        <script src="<%= request.getContextPath() %>/diamond/client/future/common/cacheWrapper/util.js"></script>
        <style type="text/css">
        	html, body
        	{
        ...
        <script>
            var imageroot = "/trunk-diamond/";
            // We must load the LFC in the head element for DHTML.
            lz.embed.lfc('<%= request.getContextPath() %>/lps/includes/lfc/LFCdhtml' + '-debug' + '.js', imageroot);
            
        </script>
        </head>
   <body><script type="text/javascript">
              lz.embed.dhtml({url: 'select.lzx?lzr=dhtml&debug=true&lzmc_string_buildid=BUILD_ID', bgcolor: '#ffffff', width: '100%', height: '100%', id: 'lzapp', accessible: 'false'});
