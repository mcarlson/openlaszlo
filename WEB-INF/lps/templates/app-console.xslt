        ...
        <xsl:if test="$isKranking">
          ...
          <center>
            <script type="text/javascript" >
                 lzEmbed({url: '<xsl:value-of select="$assets"/>/startup_small.swf', width: '400', height: '400', id: '<xsl:value-of select="/canvas/@id"/>', accessible: '<xsl:value-of select="/canvas/@accessible"/>'});
            </script>
          </center>
