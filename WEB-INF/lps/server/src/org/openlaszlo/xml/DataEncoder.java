...
throw new DataEncoderException(
/* (non-Javadoc)
 * @i18n.test
 * @org-mes="Error compiling XML from Document: " + p[0]
 */
            org.openlaszlo.i18n.LaszloMessages.getMessage(
                DataEncoder.class.getName(),"051018-604", new Object[] {e.getMessage()})
            );
        }
    }
   ...
   String getAttributeType(Attribute attr)
   {
       ...
       if      ( type == Attribute.CDATA_TYPE)      { return "CDATA"; }
       else if ( type == Attribute.ID_TYPE)         { return "ID"; }
       else if ( type == Attribute.IDREF_TYPE)      { return "IDREF"; }
       else if ( type == Attribute.IDREFS_TYPE)     { return "IDREFS"; }
       else if ( type == Attribute.ENTITY_TYPE)     { return "ENTITY"; }
       else if ( type == Attribute.ENTITIES_TYPE)   { return "ENTITIES"; }
       else if ( type == Attribute.NMTOKEN_TYPE)    { return "NMTOKEN"; }
       else if ( type == Attribute.NMTOKENS_TYPE)   { return "NMTOKENS"; }
       else if ( type == Attribute.NOTATION_TYPE)   { return "NOTATION"; }
       else if ( type == Attribute.ENUMERATED_TYPE) { return "ENUMERATED"; }
       else { return ""; }
