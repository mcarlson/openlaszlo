...
public class JavascriptCompressor /* implements Translator */ {
  ...
  static SimpleNode parseFragment(String code) {
    code =
      ...
      "\n#file JavascriptCompressor.parseFragment\n#line 0\n" +
      code +
      "}";
  ...
  Boolean evaluateCompileTimeConditional(SimpleNode node) {
    Object value = null;
    // Never evaluate them for compression
...
//     Map map = new HashMap();
//     String xtor = "class".equals(classortrait.getName())?"NewClass":"Trait";
...
//     }
  ...
  static public class JavascriptReference {
    ...
    public JavascriptReference(JavascriptCompressor translator, SimpleNode node, int referenceCount) {
  ...
  static public abstract class MemberReference extends JavascriptReference {
    ...
    public MemberReference(JavascriptCompressor translator, SimpleNode node, int referenceCount, 
                          SimpleNode object) {
  ...
  static public class VariableReference extends JavascriptReference {
    ...
    public VariableReference(JavascriptCompressor translator, SimpleNode node, int referenceCount, String name) {
      super(translator, node, referenceCount);
      this.name = name;
      ...
      if (options.getBoolean(Compiler.WARN_UNDEFINED_REFERENCES)) {
        ...
        if (variables != null) {
          ...
          if (! known) {
            this.checkedNode = ((JavascriptCompressor)translator).makeCheckedNode(node);
          }
        }
      }
    }
  ...
  static public class PropertyReference extends MemberReference {
    ...
    public PropertyReference(JavascriptCompressor translator, SimpleNode node, int referenceCount, 
...
//       }
  ...
  static public class IndexReference extends MemberReference {
    ...
    public IndexReference(JavascriptCompressor translator, SimpleNode node, int referenceCount, 
