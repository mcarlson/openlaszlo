...
public class SOAPDataEncoder implements ContentHandler {
     ...
     */
    public SOAPDataEncoder (int swfversion) {
     ...
     */
    public SOAPDataEncoder (int swfversion, int initsize) {
        this(swfversion);
        this.initsize = initsize;
    }

    public SOAPDataEncoder(int swfversion, Vector v, SOAPHeader h) {
        this(swfversion);
        buildFromElements(v, h);
    }

    public SOAPDataEncoder(int swfversion, Program p, SOAPHeader h) {
        this(swfversion);
...
//         ArrayList headers = fault.getHeaders();
    ...
    public void end() {
        ...
        program.getVar();
        program.push(3); // this, data, header
        program.push("_parent"); 
        program.getVar();
        program.push("loader"); 
