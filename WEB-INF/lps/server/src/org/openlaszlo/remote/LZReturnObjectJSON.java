 ...
 */
public class LZReturnObjectJSON
{
    public static Logger mLogger = Logger.getLogger(LZReturnObjectJSON.class);
    ...
    public LZReturnObjectJSON(String objectReturnType) {
    ...
    public static byte[] createObject(Object object, String objectReturnType)
        ...
        try {
            String buf = new LZReturnObjectJSON(objectReturnType)
