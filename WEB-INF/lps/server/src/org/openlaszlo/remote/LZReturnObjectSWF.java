 ...
 */
public class LZReturnObjectSWF
{
    public static Logger mLogger = Logger.getLogger(LZReturnObjectSWF.class);
    ...
    public LZReturnObjectSWF(String objectReturnType, int swfversion) {
        mDC = new DataContext();
...
//        mProgram.push(s);
    ...
    public static FlashFile createObjectFile(Object object, String objectReturnType, 
        ...
        Program program = new LZReturnObjectSWF(objectReturnType, swfversion)
