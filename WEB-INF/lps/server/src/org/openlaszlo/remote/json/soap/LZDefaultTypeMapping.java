...
import org.openlaszlo.remote.json.soap.encoding.LZArraySerializerFactory;
import org.openlaszlo.remote.json.soap.encoding.LZObjectSerializerFactory;
import org.openlaszlo.remote.json.soap.encoding.JSONArrayDeserializerFactory;
import org.openlaszlo.remote.json.soap.encoding.JSONObjectDeserializer;
import org.openlaszlo.remote.json.soap.encoding.JSONSimpleDeserializer;
import org.openlaszlo.remote.json.soap.encoding.JSONSimpleDeserializerFactory;
...
//         );
        ...
        myRegister(Constants.SOAP_ARRAY12, java.util.Collection.class,
                   new LZArraySerializerFactory(),
                   new JSONArrayDeserializerFactory()
        );
        // TODO: move it to the DefaultSOAPEncodingTypeMappingImpl class
        ...
        DeserializerFactory df = new JSONSimpleDeserializerFactory(java.util.Date.class, Constants.XSD_DATETIME);
    ...
    protected void myRegisterSimple(QName xmlType, Class javaType) {
        ...
        if (javaType != java.lang.Object.class) {
            df = new JSONSimpleDeserializerFactory(javaType, xmlType);
        }
