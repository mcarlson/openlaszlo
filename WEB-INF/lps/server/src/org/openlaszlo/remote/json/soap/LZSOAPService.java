...
import org.openlaszlo.remote.json.soap.encoding.JSONObjectDeserializerFactory;
...
public class LZSOAPService
{
    ...
    /** Map of JSON of services (synchronized) (key is version string like swf6,
     * swf7, etc.) */
    ...
    DeserializerFactory mObjectDeserializerFactory = 
        new JSONObjectDeserializerFactory();
    ...
    public synchronized byte[] createClientSOAPService(String swfversion, int swfnum) 
        ...
        if (swfobj == null) {
                swfobj = ClientSOAPService.createObject(this);
    ...
    /**
     * Get client JSON representation of service.
     */
    public byte[] getClientSOAPService(int swfnum) 
        throws ServiceException {
        String swfversion = "dhtml";
        byte[] swfobj = (byte[])mClientSOAPServiceMap.get(swfversion);
