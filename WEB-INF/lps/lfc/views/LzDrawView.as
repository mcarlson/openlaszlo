...
//-----------------------------------------------------------------------------
// bezierCurveTo() adds the given coordinate (x, y) to the list of points of 
...
// the given coordinate (x, y).  Approximates a cubic bezier with quadratic 
...
//-----------------------------------------------------------------------------
LzDrawView.prototype.bezierCurveTo = function(cp1x, cp1y, cp2x, cp2y, x, y) {
