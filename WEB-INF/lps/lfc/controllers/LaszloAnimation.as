...
// @keywords public
//=============================================================================
var LzAnimator = Class( "LzAnimator" , LzAnimatorGroup );

//LzAnimator.prototype.setters.from = "defaultSet";
//LzAnimator.prototype.setters.to = "defaultSet";
//LzAnimator.prototype.setters.duration = "defaultSet";
//LzAnimator.prototype.setters.attribute = "defaultSet";
//LzAnimator.prototype.setters.relative = "defaultSet";

//@field String motion: The style of motion to use for the animator. This
//is one of "linear", "easin" , "easeout" , and "easeboth". The default
//is "easeboth"
LzAnimator.prototype.setters.motion = "setMotion";

//@field Number to: The destination value for the animator.
LzAnimator.prototype.setters.to = "setTo";


LzAnimator.prototype.beginPoleDelta = .25;
LzAnimator.prototype.endPoleDelta = .25;

//------------------------------------------------------------------------------
// @keywords private
//------------------------------------------------------------------------------
LzAnimator.prototype.construct = function ( parent , args ){
...
// "easeboth".
//------------------------------------------------------------------------------
LzAnimator.prototype.setMotion = function ( eparam ){
...
//------------------------------------------------------------------------------
LzAnimator.prototype.setTo = function ( eparam ){
...
// caluclauted once even if the animator repeats
//
// @keywords private
//------------------------------------------------------------------------------
...
LzAnimator.prototype.doStart = function (){
...
// @keywords private
//------------------------------------------------------------------------------
LzAnimator.prototype.prepareStart = function ( ){
...
// @keywords private
//-----------------------------------------------------------------------------
LzAnimator.prototype.resetAnimator = function() {
    // Set the attribute of the view to its "from" value but make sure
    // expectedAttribute is updated.
    if ( this.from != null ){
...
//-----------------------------------------------------------------------------
LzAnimator.prototype.beginAnimator = function( time ) {
    ...
    this.lastIterationTime = time;
     ...
     //@field LzEvent onstart: Sent when the animator starts.
...
// @keywords private
//-----------------------------------------------------------------------------
LzAnimator.prototype.stop = function( ) {
...
// @keywords private
//-----------------------------------------------------------------------------
LzAnimator.prototype.__LZfinalizeAnim = function( ) {
...
//-----------------------------------------------------------------------------
LzAnimator.prototype.calcNextValue = function( timeDifference ) {
...
// @keywords private
//------------------------------------------------------------------------------
LzAnimator.prototype.calcNextValueLinear = function( timeDifference ) {
...
//-----------------------------------------------------------------------------
LzAnimator.prototype.update = function( time ) {
...
//-----------------------------------------------------------------------------
LzAnimator.prototype.setValue = function( value ) {
...
// @keywords private
//------------------------------------------------------------------------------
LzAnimator.prototype.toString = function(){
