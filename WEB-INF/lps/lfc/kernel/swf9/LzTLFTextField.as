...
/**
   Implementation of the flash.text.TextField API, using the Flash
...
public class LzTLFTextField extends Sprite implements IFontContextComponent
{
    ...
    #passthrough (toplevel:true) {
        ...
        /**
         *  LzTLFTextField is a Sprite which displays text by using the Text
         *  Layout Framework to implement the old TextField API.
         * 
        ...
        /**
         *  This method has been implemented in LzTLFTextField
         *  to simply return a copy of the <code>defaultTextFormat</code>,
         *  because LzTLFTextField does not support formatting a range.
         * 
        ...
        /**
         *  This method has no effect on a LzTLFTextField if <code>beginIndex</code>
        ...
        // Forward the event from textContainerManager to 'this'
