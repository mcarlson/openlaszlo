...
public class LzTLFEditManager extends EditManager {
    ...
    #passthrough (toplevel:true) {
        ...
        public function LzTLFEditManager(undoManager:IUndoManager, owner:LzTLFTextField)
        {
            super(undoManager);
            this.textfield = owner;
            //Debug.info("LzTLFEditManager constructor", owner);
        }

        override public function mouseOverHandler(event:MouseEvent):void {
            if (textfield.enabled || textfield.clickable)  {
                super.mouseOverHandler(event);
                //Debug.info("LzTLFEditManager mouseOverHandler [1]", event);
                //                textfield.__mouseEvent(event);
            } else {
                //Debug.info("LzTLFEditManager mouseOverHandler [2] ", event);
        ...
        public override function  activateHandler(event:Event):void {
            ...
            //Debug.info(" activateHandler", textfield.enabled, event);
        }
