...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:import href="../../../../tools/docbook-xsl-1.65.1/fo/docbook.xsl"/>
  ...
  <xsl:param name="draft.watermark.image" select="'../../../tools/docbook-xsl-1.65.1/images/draft.png'"/>
  <!-- Cross References -->
  <xsl:param name="insert.xref.page.number" select="'yes'"/>

  <xsl:param name="callouts.extension" select="'1'"/>
  <xsl:param name="callout.graphics.path" select="'../../../tools/docbook-xsl-1.65.1/images/callouts/'"/>
